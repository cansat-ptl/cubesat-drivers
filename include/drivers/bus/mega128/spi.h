...
#ifndef KDRIVER_SPI_H_
#define KDRIVER_SPI_H_
...
/* SPI mode predefines */
#define BUS_SPI_MODE0 0
#define BUS_SPI_MODE1 1
#define BUS_SPI_MODE2 2
#define BUS_SPI_MODE3 3
/*
 *	Possible SPI modes:
...
#define BUS_SPI_MSBFIRST 0
#define BUS_SPI_LSBFIRST 1
/* SPI speed predefines */
#define BUS_SPI_PRESCALER_4 0
#define BUS_SPI_PRESCALER_16 1
#define BUS_SPI_PRESCALER_64 2
#define BUS_SPI_PRESCALER_128 3
/* SPI transfer modes */
#define BUS_SPI_WRITE 1
#define BUS_SPI_READ 0
